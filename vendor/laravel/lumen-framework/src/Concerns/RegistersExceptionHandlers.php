...
trait RegistersExceptionHandlers
{
    ...
    //bindings或者instances中是否存在'Illuminate\Contracts\Debug\ExceptionHandler'
    //var_dump($this->bound('Illuminate\Contracts\Debug\ExceptionHandler'));
